...
class PlotlytempgraphPlugin(octoprint.plugin.SettingsPlugin,
	...
	def get_settings_defaults(self):
		return {
			...
			"name_map": [{"identifier": "tool0 actual", "label": "tool0 actual", "color": "", "hover_color": "", "hover_template": "", "hidden": False, "use_fahrenheit": False, "use_sub_plot": False},
						 {"identifier": "tool0 target", "label": "tool0 target", "color": "", "hover_color": "", "hover_template": "", "hidden": False, "use_fahrenheit": False, "use_sub_plot": False},
						 {"identifier": "bed actual", "label": "bed actual", "color": "", "hover_color": "", "hover_template": "", "hidden": False, "use_fahrenheit": False, "use_sub_plot": False},
						 {"identifier": "bed target", "label": "bed target", "color": "", "hover_color": "", "hover_template": "", "hidden": False, "use_fahrenheit": False, "use_sub_plot": False},
						 {"identifier": "chamber actual", "label": "chamber actual", "color": "", "hover_color": "", "hover_template": "", "hidden": False, "use_fahrenheit": False, "use_sub_plot": False},
						 {"identifier": "chamber target", "label": "chamber target", "color": "", "hover_color": "", "hover_template": "", "hidden": False, "use_fahrenheit": False, "use_sub_plot": False}],
